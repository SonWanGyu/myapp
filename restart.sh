...
echo "  👉 빌드 성공 후 포트 포워딩 2개 실행:"
echo "     kubectl port-forward svc/node-app-service 3000:3000 --address 0.0.0.0"
echo "     kubectl port-forward svc/spring-boot-service 8080:8080 --address 0.0.0.0"
echo "========================================="
