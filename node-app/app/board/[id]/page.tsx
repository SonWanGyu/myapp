...
export default function BoardDetail() {
  ...
  const fetchBoardDetail = async (boardId: string): Promise<void> => {
    try {
  ...
  const canEditOrDelete: boolean = !!(currentUser && (board.authorEmail === currentUser.email || currentUser.role === 'ADMIN'));
